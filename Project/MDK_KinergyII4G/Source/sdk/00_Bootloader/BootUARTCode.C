...
//    INT8U bTemp;
    ...
    else if(cbUART5 == bUARTx)
    {
       ...
       // HalRccPeriphOn(cbRCC_APB2, cdwRCC_APB2_PERIPH_AFIO);//AFIO CLK EN
        ...
        RS485_GPIO_RCC_OPEN();
        M_PORT_SET_PIN_HIGH(GPIOC, UART5_TX_PIN);
        _HAL_GPIO_SET_MODE(GPIOC, UART5_TX_PIN, AF_MODE_PUSH_PULL);
        
        M_PORT_SET_PIN_HIGH(UART5_RX_PORT, UART5_RX_PIN);
        _HAL_GPIO_SET_MODE(UART5_RX_PORT, UART5_RX_PIN, INPUT_PULL_UP);    
#endif
