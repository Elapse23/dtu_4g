#include "lte_4g_module_tcp_at_driver.h"
...
*   tcp at driver state
************************************************************************************************************/
uint8_t lte_4g_module_driver_tcp_at_driver_state(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    ...
    lte_4g_module_driver_process_contral *pst_driver_contral_info = (lte_4g_module_driver_process_contral *)pv_user_data;
    ...
    if(strstr((char *)pst_lte_module_data_info->pb_data,"WIFI"))
    {
        ...
        return 1;
            ...
            (lte_4g_module_operate_receive_tcp_user_data == pst_driver_contral_info->st_operate_result.b_iot_module_operation))
    {
        pst_driver_contral_info->st_operate_result.b_err_code = ap_connection_closed;
        return 0;
    }
	else if(NULL != (uint8_t *)strstr((char*)pst_lte_module_data_info->pb_data,"+QIURC: \"closed\""))
	{
		pst_driver_contral_info->st_operate_result.b_err_code = tcp_connection_closed;
        return 1;
	}
	else if(NULL != (uint8_t *)strstr((char*)pst_lte_module_data_info->pb_data,"ERROR"))
	{
		pst_driver_contral_info->st_operate_result.b_err_code = tcp_connection_closed;
        return 1;
	}
...
*   tcp receive notify
************************************************************************************************************/
extern uint16_t w_receive_data_len;
uint8_t lte_4g_module_driver_receive_check(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return 0;
	...
	static uint8_t cb_4g_receive_now = 0;
	if(NULL != (uint8_t *)strstr((char*)pst_lte_module_data_info->pb_data,"+QIURC: \"recv\""))
	{
		cb_4g_receive_now = 1;
	}

    pb_data = (uint8_t *)strstr((char*)pst_lte_module_data_info->pb_data,"+QIRD:");
    if(NULL != pb_data && 1 == cb_4g_receive_now)
    {
        if(sscanf((char *)pb_data,"+QIRD: %d",&dw_data_temp_0))
        {
            if(dw_data_temp_0 != 0)
            {
                w_receive_data_len = dw_data_temp_0;
                if(dw_data_temp_0 > 1500)
                {
                    dw_data_temp_0 = 0;
                }
                cb_4g_receive_now = 0;
...
uint8_t lte_4g_module_driver_receive_tcp_notify(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    if(TRUE == lte_4g_module_driver_tcp_at_driver_state(pv_user_data,pst_lte_module_data_info))
    {
        return 1;
    }

    lte_4g_module_driver_process_contral *pst_config_info = (lte_4g_module_driver_process_contral *)pv_user_data;

    if(TRUE == lte_4g_module_driver_receive_check(pv_user_data,pst_lte_module_data_info))
    {
        f_receive_data_en = TRUE;
        if(lte_4g_module_operate_receive_tcp_user_data ==\
...
uint8_t lte_4g_module_driver_send_at_tcp_connect(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    ...
    lte_4g_module_driver_process_contral *pst_process_contral = (lte_4g_module_driver_process_contral *)pv_user_data;
    lte_4g_module_driver_config_info_general *pst_config_info = pst_process_contral->pst_config_info;
       ...
       (cb_max_ip_connect_cnt >= net_connect_ip_cnt_get()))
    {
        ...
        if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QIOPEN=1,0,\"TCP\",\"%d.%d.%d.%d\",%d,0,0\r\n",
                        pb_domain_ip[0],
                        pb_domain_ip[1],
                        pb_domain_ip[2],
                        pb_domain_ip[3],
    ...
    else
    {
        ...
        if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QIOPEN=1,0,\"TCP\",\"%s\",%d,0,0\r\n",
                        pb_domain_ip,
                        w_port))
        {
            return FALSE;
...
uint8_t lte_4g_module_driver_receive_at_tcp_connect(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    ...
    if(NULL != strstr((char*)pst_lte_module_data_info->pb_data,"+QIOPEN: 0,0"))
    {
        return 1;
    }
...
/*tcp close*/
//AT+QICLOSE=0\r\n
uint8_t lte_4g_module_driver_send_at_tcp_close(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
...
//    lte_module_driver_config_info_general *pst_config_info = (lte_module_driver_config_info_general *)pv_user_data;
	...
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QICLOSE=0\r\n"))
	{
		return FALSE;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_tcp_close(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if(NULL == pst_lte_module_data_info)
	{
		return FALSE;
...
/*tcp state*/
//AT+CIPSTATE?\r\n
uint8_t lte_4g_module_driver_send_at_tcp_state(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
	...
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QISTATE?\r\n"))
	{
		return FALSE;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_tcp_state(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return 0;
	...
	if(sscanf(strstr((char*)pst_lte_module_data_info->pb_data,"+QISTATE:"),"+QISTATE: %d",&dw_data_temp_0) != 0)
	{
        return 1;
	}
...
uint8_t lte_4g_module_tcp_channel_connect(lte_4g_module_driver_config_info_general *pst_config_info,
                                         lte_4g_module_driver_process_contral *pst_process_contral)
{
    ...
    do{
        switch(b_step)
        {
            case cb_lte_connect_tcp_channel_connect_connect:
            {
                ...
                b_result_ = lte_module_driver_at_cmd_transmit(60000,pst_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                                             lte_4g_module_driver_send_at_tcp_connect,
                                                             lte_4g_module_driver_receive_at_tcp_connect);
                if(1 == b_result_)
                {
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(3000,pst_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                                             lte_4g_module_driver_send_at_tcp_state,
                                                             lte_4g_module_driver_receive_at_tcp_state))
                {
                    b_result = TRUE;
                    b_step = cb_lte_connect_tcp_channel_connect_none;
                }
...
//    #define cb_lte_connect_tcp_client_id_allocate						0
    ...
    lte_4g_module_driver_process_contral st_process_contral =
    {
        ...
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_open_tcp_connection,
    ...
    do
    {
        switch(b_step)
        {
            ...
            {
                if(TRUE == lte_4g_module_tcp_channel_connect(pst_config_info,&st_process_contral))
                {
...
uint8_t lte_4g_module_driver_close_tcp_connection(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_close_tcp_connection,
        .st_operate_result.b_err_code = lte_module_err_none,
    };
    ...
    do
    {
        switch(b_step)
        {
            case cb_lte_connect_tcp_channel_disconnect_disconnect:
            {
                ...
                b_disconnect_result = lte_module_driver_at_cmd_transmit(10000,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                                                        lte_4g_module_driver_send_at_tcp_close,
                                                                        lte_4g_module_driver_receive_at_tcp_close);
...
uint8_t lte_4g_module_driver_reset_tcp_connection(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_reset_tcp_connection,
        .st_operate_result.b_err_code = lte_module_err_none,
    };
    ...
    do
    {
        switch(b_step)
        {
            ...
            case cb_lte_connect_tcp_channel_reset_connect:
            {
                ...
                b_connect_result = lte_module_driver_at_cmd_transmit(15000,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                                                     lte_4g_module_driver_send_at_tcp_connect,
                                                                     lte_4g_module_driver_receive_at_tcp_connect);
...
uint8_t lte_4g_module_driver_send_at_tcp_cmd(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
...
uint8_t lte_4g_module_driver_receive_at_tcp_cmd(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if(NULL == pst_lte_module_data_info)
	{
		return 0;		//错误
...
uint8_t lte_4g_module_driver_send_at_tcp_user_data(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
...
uint8_t lte_4g_module_driver_receive_at_tcp_user_data(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if(NULL == pst_lte_module_data_info)
	{
		return FALSE;
...
uint8_t lte_4g_module_driver_send_tcp_user_data(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    lte_4g_module_driver_process_contral st_process_contral =
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_err_code = lte_module_err_none,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_send_tcp_user_data,
        .pst_config_info = pst_config_info,
    };
	...
	do
	{
		switch(b_step)
		{
			...
			{
				if(TRUE == lte_module_driver_at_cmd_transmit(3000,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
															 lte_4g_module_driver_send_at_tcp_cmd,
															 lte_4g_module_driver_receive_at_tcp_cmd))
				{
			...
			{
                if(TRUE == lte_module_driver_at_cmd_transmit(10000,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                                             lte_4g_module_driver_send_at_tcp_user_data,
                                                             lte_4g_module_driver_receive_at_tcp_user_data))
                {
...
uint8_t lte_4g_module_driver_send_at_receive_tcp_message(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
...
//            (w_receive_data_len >= cb_max_network_data_len)?w_receive_data_len:cb_max_network_data_len;
		...
		w_max_buff_len = (w_max_buff_len > 0) ? w_max_buff_len : (cb_max_network_data_len - 2);
		w_max_buff_len = cb_max_network_data_len - 2;
        if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,
                        "AT+QIRD=0,%d\r\n",
                        w_max_buff_len))
        {
...
uint8_t lte_4g_module_driver_receive_at_receive_tcp_message(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    ...
    lte_4g_module_driver_process_contral *pst_process_contral_info = (lte_4g_module_driver_process_contral *)pv_user_data;
    ...
    {
        if(0 != strstr((char*)pst_lte_module_data_info->pb_data,"ERROR"))
        {
            pst_process_contral_info->st_operate_result.b_err_code = tcp_connection_closed;
            goto RESPONSE;
        }
        if(0 == strstr((char*)pst_lte_module_data_info->pb_data,"+QIRD:"))
        {
        ...
        if(0 == sscanf(strstr((char *)pst_lte_module_data_info->pb_data,"+QIRD:"),
                       "+QIRD:%d,",
                       &dw_data_len))
        {
            pst_process_contral_info->st_operate_result.b_err_code = tcp_receive_user_data_fail;
...
//        }
        ...
        dw_receive_data_len = pst_lte_module_data_info->w_data_len - 12 -\
                                (((dw_data_len/1000)>0?1:0) +\
                                 ((dw_data_len/100)>0?1:0) +\
                                 ((dw_data_len/10)>0?1:0));
...
uint8_t lte_4g_module_driver_receive_tcp_user_data(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    lte_4g_module_driver_process_contral st_process_contral =
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_err_code = lte_module_err_none,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_receive_tcp_user_data,
        .pst_config_info = pst_config_info,
    };
	lte_module_driver_at_cmd_transmit(100,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                      0,
                                      0);
    lte_module_driver_at_cmd_transmit(1000,&st_process_contral,lte_4g_module_driver_receive_tcp_notify,
                                      lte_4g_module_driver_send_at_receive_tcp_message,
                                      lte_4g_module_driver_receive_at_receive_tcp_message);
...
uint8_t lte_module_driver_receive_at_chk_sim_signal(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    ...
    if(NULL != pb_data)
    {
        if(sscanf((char *)pb_data,"+CSQ: %d,%d",&pst_config_info->union_config_info.st_get_sim_info_connection.pst_data_info->b_signal_pct,
                  &pst_config_info->union_config_info.st_get_sim_info_connection.pst_data_info->b_channel_bit_error_rate))
        {
            if(pst_config_info->union_config_info.st_get_sim_info_connection.pst_data_info->b_signal_pct != 99)
            {
				network_ap_connect_err_code_set(cb_sim_connect_normal);
                return 1;
            }
			else
			{
				network_ap_connect_err_code_set(cb_sim_connect_fail);
                return 0;
...
uint8_t lte_4g_module_get_sim_info(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_get_sim_info,
        .st_operate_result.b_err_code = sim_get_info_fail,
    };
    ...
    {
        st_process_contral.st_operate_result.b_err_code = sim_get_info_success;
    }
