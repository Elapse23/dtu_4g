...
// Bootloader数据类型定义 - 原bootloader_types.h内容
#ifndef INT8U
...
// 偏移量变量和全局变量定义 - 映射到特定内存地址
#define dwBootFlashCodeAddrOffset       (*(INT32U*)cdwRAM_BOOTCODEADDR1_OFFSET_ADDR)
#define dwBootUARTCodeAddrOffset        (*(INT32U*)cdwRAM_BOOTCODEADDR2_OFFSET_ADDR)
#define dwBootCANCodeAddrOffset         (*(INT32U*)cdwRAM_BOOTCODEADDR3_OFFSET_ADDR)
#define dwBootSpiFlashCodeAddrOffset    (*(INT32U*)cdwRAM_BOOTCODEADDR4_OFFSET_ADDR)
#define dwBootRodataAddrOffset          (*(INT32U*)cdwRAM_BOOTCODEADDR5_OFFSET_ADDR)
#define stUpdateUARTInfo                (*(UpdateUARTInfo*)cdwRAM_UARTUPDATEINFO_ADDR)
#define stTransUARTInfo                 (*(UARTTransInfo*)cdwRAM_UARTTRANSINFO_ADDR)
#define stUpdateSPIFlashInfo            (*(UpdateSPIFlashInfo*)cdwRAM_UPDATE_SPIFLASHINFO_ADDR)
#define stUpdatePackInfo                (*(UpdatePackInfo*)cdwRAM_UPDATEPACKINFO_ADDR)
#define stBootDevTree                   ((DevTreeInfo*)cdwRAM_DEVTREEINFO_ADDR)

// 添加缺失的变量定义
#define dw_firmware_update_task_delay   300  // 固件更新任务延迟 (ms)
...
#define HAL_GPIO_SET_HIGHT(...)                 M_PORT_SET_PIN_HIGH(__VA_ARGS__)
#define HAL_GPIO_SET_LOW(...)                   M_PORT_SET_PIN_LOW(__VA_ARGS__)
#define HAL_GPIO_TOGGLE(...)                    M_PORT_SET_PIN_TOGGLE(__VA_ARGS__)
#define HAL_GPIO_READ(...)                      M_PORT_PIN_READ(__VA_ARGS__)
#define HAL_GPIO_IS_SET(...)                    M_PORT_PIN_IS_SET(__VA_ARGS__)
...
#define HAL_GPIO_SET_MODE(...)                  _HAL_GPIO_SET_MODE(__VA_ARGS__)
