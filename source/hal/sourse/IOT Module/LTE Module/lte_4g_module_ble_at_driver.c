...
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QBTPWR=0\r\n"))
	{
		return 0;
	}
...
//AT+BLEGATTSSRVCRE
uint8_t lte_4g_module_driver_send_at_ble_ssrv(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QBTGATSS=0,1,6159,1\r\n"))
	{
		return 0;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_ble_ssrv(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    if(strstr((char*)pst_lte_module_data_info->pb_data,"\r\nOK") != 0)
    {
        return 1;
...
//AT+BLEADVDATAEX
uint8_t lte_4g_module_driver_send_at_ble_advdataex(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
...
uint8_t lte_4g_module_driver_receive_at_ble_advdataex(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    if(strstr((char*)pst_lte_module_data_info->pb_data,"\r\nOK") != 0)
    {
        return 1;
...
uint8_t lte_4g_module_driver_send_at_ble_adv_para(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,
                    "AT+QBTGATADV=1,50,50,0,0,7,0\r\n"))
	{
		return 0;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_ble_adv_para(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    if(strstr((char*)pst_lte_module_data_info->pb_data,"\r\nOK") != 0)
    {
        return 1;
...
//AT+BLEADVDATA=data
uint8_t lte_4g_module_driver_send_at_ble_advdata(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    ...
    if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,
                    "AT+QBTADVDATA=27,\"020106%02X0957434D5F%s030302A0\"\r\n",
...
uint8_t lte_4g_module_driver_receive_at_ble_advdata(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
...
uint8_t lte_4g_module_driver_send_at_ble_addr(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QBTLEADDR?\r\n"))
	{
		return 0;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_ble_addr(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    uint8_t *pb_data = 0;

    pb_data = (uint8_t *)strstr((char*)pst_lte_module_data_info->pb_data,"+QBTLEADDR");
    if(pb_data)
    {
...
//AT+BLEGATTSSRVSTART
uint8_t lte_4g_module_driver_send_at_ble_ssrv_start(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QBTGATSSC=1,1\r\n"))
	{
		return 0;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_ble_ssrv_start(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    if((pst_lte_module_data_info->w_data_len < 8) &&\
       (strstr((char*)pst_lte_module_data_info->pb_data,"OK") != 0))
    {
...
//AT+BLEADVSTART
uint8_t lte_4g_module_driver_send_at_ble_adv_start(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
	if(0 == sprintf((char *)pst_lte_module_data_info->pb_data,"AT+QBTADV=1\r\n"))
	{
		return 0;
	}
	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);
...
uint8_t lte_4g_module_driver_receive_at_ble_adv_start(void *pv_user_data, lte_module_data_info *pst_lte_module_data_info)
{
    if((pst_lte_module_data_info->w_data_len < 8) &&\
       (strstr((char*)pst_lte_module_data_info->pb_data,"OK") != 0))
    {
...
uint8_t lte_4g_module_ble_config(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    lte_4g_module_driver_process_contral st_process_contral =
    {
        ...
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_ble_config,
...
//            }break;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_ssrv,
                                                             lte_4g_module_driver_receive_at_ble_ssrv))
                {
                    b_err_cnt = 0;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_adv_para,
                                                             lte_4g_module_driver_receive_at_ble_adv_para))
                {
                    b_err_cnt = 0;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_advdata,
                                                             lte_4g_module_driver_receive_at_ble_advdata))
                {
                    b_err_cnt = 0;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_addr,
                                                             lte_4g_module_driver_receive_at_ble_addr))//mark ble addr
                {
                    b_err_cnt = 0;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_ssrv_start,
                                                             lte_4g_module_driver_receive_at_ble_ssrv_start))
                {
                    b_err_cnt = 0;
            ...
            {
                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pv_user_data,0,
                                                             lte_4g_module_driver_send_at_ble_adv_start,
                                                             lte_4g_module_driver_receive_at_ble_adv_start))
                {
                    b_err_cnt = 0;
...
uint8_t lte_4g_module_open_broadcast(lte_4g_module_driver_config_info_general *pst_config_info)
{
    if(0 == pst_config_info)
    {
        return FALSE;
    ...
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_ble_open_broadcast,
...
uint8_t lte_4g_module_ble_deinit(lte_4g_module_driver_config_info_general *pst_config_info)
{
    if(0 == pst_config_info)
    {
        return FALSE;
    ...
    {
        .st_operate_result.b_iot_module_type = iot_module_type_4g,
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_ble_close,
...
//AT+QBTLESEND=<cid>,<type>,<data_length>,<data>

uint8_t lte_4g_module_driver_send_at_ble_cmd(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
    ...
    if(0 == pst_config_info->union_config_info.st_send_ble_user_data.st_data_info.w_data_len && NULL == pst_config_info->union_config_info.st_send_ble_user_data.st_data_info.pb_data)
    {
        return FALSE;
    }
    ...
    {
        pst_lte_module_data_info->pb_data[w_cnt_i + 22] =\
            pst_config_info->union_config_info.st_send_ble_user_data.st_data_info.pb_data[w_cnt_i];
    }
	pst_lte_module_data_info->w_data_len = pst_config_info->union_config_info.st_send_ble_user_data.st_data_info.w_data_len + 22;
//	pst_lte_module_data_info->w_data_len = strlen((char *)pst_lte_module_data_info->pb_data);

	return TRUE;
}
uint8_t lte_4g_module_driver_receive_at_ble_cmd(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
...
uint8_t lte_4g_module_driver_send_at_ble_user_data(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if((NULL == pv_user_data) || (NULL == pst_lte_module_data_info))
	{
		return FALSE;
...
uint8_t lte_4g_module_driver_receive_at_ble_user_data(void *pv_user_data,lte_module_data_info *pst_lte_module_data_info)
{
	if(NULL == pst_lte_module_data_info)
	{
		return FALSE;
...
uint8_t lte_4g_module_driver_send_ble_user_data(lte_4g_module_driver_config_info_general *pst_config_info)
{
    ...
    lte_4g_module_driver_process_contral st_process_contral =
    {
        ...
        .st_operate_result.b_iot_module_operation = lte_4g_module_operate_send_ble_user_data,
		...
		switch(b_step)
		{
			case cb_lte_ble_send_cmd:
			{
				if(TRUE == lte_module_driver_at_cmd_transmit(1000,pst_config_info,0,
															 lte_4g_module_driver_send_at_ble_cmd,
															 lte_4g_module_driver_receive_at_ble_cmd))
				{
...
//			{
//                if(TRUE == lte_module_driver_at_cmd_transmit(1000,pst_config_info,0,
//                                                             lte_4g_module_driver_send_at_ble_user_data,
//                                                             lte_4g_module_driver_receive_at_ble_user_data))
//                {
//                    st_process_contral.st_operate_result.b_err_code = ble_send_user_data_success;
//                    b_step = cb_lte_ble_none;
//                }
